...
cpdef int prepare_sqe_batch_submit_wait_advance(io_uring ring,
                              unsigned int n_req,
...
cpdef int prepare_sqe_batch_submit_wait_advance_timeout(
            io_uring ring,
            unsigned int n_req,
            uintptr_t[:] buffer_addrs,
            int fd,
...
cpdef int write_prepare_sqe_batch_submit_wait_advance(io_uring ring,
