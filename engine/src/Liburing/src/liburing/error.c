...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "liburing.error",
        "sources": [
            "src/liburing/error.pyx"
        ]
    },
    "module_name": "liburing.error"
}
END: Cython Metadata */
...
#define __PYX_HAVE__liburing__error
#define __PYX_HAVE_API__liburing__error
/* Early includes */
#include <errno.h>
#include <string.h>
#ifdef _OPENMP
...
/*--- Type declarations ---*/
struct __pyx_opt_args_8liburing_5error_trap_error;
struct __pyx_opt_args_8liburing_5error_raise_error;
struct __pyx_opt_args_8liburing_5error_memory_error;
struct __pyx_opt_args_8liburing_5error_index_error;

/* "liburing/error.pxd":5
 * 
 * 
...
/* Module declarations from "liburing.error" */
static CYTHON_INLINE int __pyx_f_8liburing_5error_trap_error(int, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_trap_error *__pyx_optional_args); /*proto*/
static CYTHON_INLINE void __pyx_f_8liburing_5error_raise_error(struct __pyx_opt_args_8liburing_5error_raise_error *__pyx_optional_args); /*proto*/
static CYTHON_INLINE void __pyx_f_8liburing_5error_memory_error(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_memory_error *__pyx_optional_args); /*proto*/
static CYTHON_INLINE void __pyx_f_8liburing_5error_index_error(PyObject *, unsigned int, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_index_error *__pyx_optional_args); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "liburing.error"
extern int __pyx_module_is_main_liburing__error;
int __pyx_module_is_main_liburing__error = 0;

/* Implementation of "liburing.error" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_8liburing_5error_trap_error(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_no, PyObject *__pyx_v_msg); /* proto */
static PyObject *__pyx_pf_8liburing_5error_2memory_error(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_msg); /* proto */
static PyObject *__pyx_pf_8liburing_5error_4index_error(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, unsigned int __pyx_v_index, PyObject *__pyx_v_msg); /* proto */
...
#define __pyx_kp_u_Trap_Error_Type_no_int_msg_str __pyx_string_tab[3]
...
#define __pyx_kp_u_is_out_of_memory __pyx_string_tab[10]
#define __pyx_kp_u_out_of_range __pyx_string_tab[11]
#define __pyx_kp_u_src_liburing_error_pyx __pyx_string_tab[12]
#define __pyx_kp_u_trap_error_line_1 __pyx_string_tab[13]
...
#define __pyx_n_u_index_error __pyx_string_tab[20]
#define __pyx_n_u_is_coroutine __pyx_string_tab[21]
#define __pyx_n_u_items __pyx_string_tab[22]
#define __pyx_n_u_liburing_error __pyx_string_tab[23]
#define __pyx_n_u_main __pyx_string_tab[24]
#define __pyx_n_u_memory_error __pyx_string_tab[25]
#define __pyx_n_u_module __pyx_string_tab[26]
#define __pyx_n_u_msg __pyx_string_tab[27]
#define __pyx_n_u_name __pyx_string_tab[28]
#define __pyx_n_u_no __pyx_string_tab[29]
...
#define __pyx_n_u_trap_error __pyx_string_tab[37]
#define __pyx_n_u_values __pyx_string_tab[38]
#define __pyx_kp_b_int_int_int___pyx_skip_dispatch __pyx_string_tab[39]
#define __pyx_kp_b_iso88591_4A_Qc_j_aq __pyx_string_tab[40]
#define __pyx_kp_b_iso88591_Gq_AS_Z_AYaq __pyx_string_tab[41]
#define __pyx_kp_b_iso88591_L_s_Q_q_1D __pyx_string_tab[42]
...
/* "liburing/error.pyx":1
 * cpdef inline int trap_error(int no, str msg='') except -1 nogil:             # <<<<<<<<<<<<<<
 *     ''' Trap Error
 * 
*/

static PyObject *__pyx_pw_8liburing_5error_1trap_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static CYTHON_INLINE int __pyx_f_8liburing_5error_trap_error(int __pyx_v_no, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_trap_error *__pyx_optional_args) {
  PyObject *__pyx_v_msg = ((PyObject*)__pyx_mstate_global->__pyx_kp_u_);
  int __pyx_r;
  int __pyx_t_1;
  struct __pyx_opt_args_8liburing_5error_raise_error __pyx_t_2;
  int __pyx_lineno = 0;
 ...
 * 
*/
  __pyx_t_1 = (__pyx_v_no >= 0);
  if (__pyx_t_1) {

    /* "liburing/error.pyx":31
 *     '''
 *     if no >= 0:
 *         return no             # <<<<<<<<<<<<<<
 * 
...
*/
        __pyx_t_2.__pyx_n = 2;
        __pyx_t_2.no = __pyx_v_no;
        __pyx_t_2.msg = __pyx_v_msg;
        __pyx_f_8liburing_5error_raise_error(&__pyx_t_2); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L5_error)
      }
...
*/
  ...
  __Pyx_AddTraceback("liburing.error.trap_error", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
PyDoc_STRVAR(__pyx_doc_8liburing_5error_trap_error, "trap_error(int no, str msg='') -> int\n\nTrap Error\n\nType\n    no     int\n    msg    str\n    return int\n\nExample\n    >>> trap_error(1)\n    1\n\n    >>> trap_error(-11)\n    BlockingIOError: [Errno 11] Resource temporarily unavailable\n\n    >>> trap_error(-11, 'some message')\n    BlockingIOError: [Errno 11] some message\n\n    >>> trap_error(-1)\n    # dynamic error based on `errno`\n\nNote\n    - any `no >= 0` is considered safe.\n    - if `no=-1` it will check with `errno` first to see if proper error is set,\n      and raise that as exception\n\nSpecial\n    Thanks to \"_habnabit\" for coming up with this function name");
static PyMethodDef __pyx_mdef_8liburing_5error_1trap_error = {"trap_error", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8liburing_5error_1trap_error, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_8liburing_5error_trap_error};
static PyObject *__pyx_pw_8liburing_5error_1trap_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("trap_error (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_no,&__pyx_mstate_global->__pyx_n_u_msg,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "trap_error", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      if (!values[1]) values[1] = __Pyx_NewRef(((PyObject*)__pyx_mstate_global->__pyx_kp_u_));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("trap_error", 0, 1, 2, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  2:
    ...
    __pyx_v_no = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_no == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L3_error)
    __pyx_v_msg = ((PyObject*)values[1]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("trap_error", 0, 1, 2, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_msg), (&PyUnicode_Type), 1, "msg", 1))) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_r = __pyx_pf_8liburing_5error_trap_error(__pyx_self, __pyx_v_no, __pyx_v_msg);
...
static PyObject *__pyx_pf_8liburing_5error_trap_error(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_no, PyObject *__pyx_v_msg) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  struct __pyx_opt_args_8liburing_5error_trap_error __pyx_t_2;
  PyObject *__pyx_t_3 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("trap_error", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.msg = __pyx_v_msg;
  __pyx_t_1 = __pyx_f_8liburing_5error_trap_error(__pyx_v_no, 1, &__pyx_t_2); if (unlikely(__pyx_t_1 == ((int)-1))) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static CYTHON_INLINE void __pyx_f_8liburing_5error_raise_error(struct __pyx_opt_args_8liburing_5error_raise_error *__pyx_optional_args) {
  int __pyx_v_no = ((int)-1);
  PyObject *__pyx_v_msg = ((PyObject*)__pyx_mstate_global->__pyx_kp_u_);
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
...
*/
  ...
  __pyx_t_1 = __pyx_v_no;
  __pyx_L3_bool_binop_done:;
  __pyx_v_no = __pyx_t_1;

  /* "liburing/error.pyx":40
 *     ''' This function will only raise Error '''
 *     no = -errno or no
 *     raise OSError(-no, msg or strerror(-no).decode())             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_t_4 = NULL;
  __pyx_t_5 = __Pyx_PyLong_From_int((-__pyx_v_no)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_IsTrue(__pyx_v_msg); if (unlikely((__pyx_t_7 < 0))) __PYX_ERR(0, 40, __pyx_L1_error)
  if (!__pyx_t_7) {
  } else {
    __Pyx_INCREF(__pyx_v_msg);
    __pyx_t_6 = __pyx_v_msg;
    goto __pyx_L5_bool_binop_done;
  }
  __pyx_t_8 = strerror((-__pyx_v_no));
  __pyx_t_9 = __Pyx_ssize_strlen(__pyx_t_8); if (unlikely(__pyx_t_9 == ((Py_ssize_t)-1))) __PYX_ERR(0, 40, __pyx_L1_error)
  __pyx_t_10 = __Pyx_decode_c_string(__pyx_t_8, 0, __pyx_t_9, NULL, NULL, NULL); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 40, __pyx_L1_error)
  ...
  __pyx_t_11 = 1;
  {
    ...
    __pyx_t_3 = __Pyx_PyObject_FastCall((PyObject*)(((PyTypeObject*)PyExc_OSError)), __pyx_callargs+__pyx_t_11, (3-__pyx_t_11) | (__pyx_t_11*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
...
*/
  ...
  __Pyx_AddTraceback("liburing.error.raise_error", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
}

/* "liburing/error.pyx":43
 * 
 * 
...
static PyObject *__pyx_pw_8liburing_5error_3memory_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static CYTHON_INLINE void __pyx_f_8liburing_5error_memory_error(PyObject *__pyx_v_self, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_memory_error *__pyx_optional_args) {
  PyObject *__pyx_v_msg = ((PyObject*)__pyx_mstate_global->__pyx_kp_u_is_out_of_memory);
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("memory_error", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_msg = __pyx_optional_args->msg;
    }
...
*/
  __pyx_t_2 = NULL;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_mstate_global->__pyx_n_u_class); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_name); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_FormatSimple(__pyx_t_4, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyUnicode_Unicode(__pyx_v_msg); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_6 = __Pyx_PyUnicode_Join(__pyx_t_5, 4, 1 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_3) + 4 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_4), 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_3) | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_4));
...
*/
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_AddTraceback("liburing.error.memory_error", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
}
...
PyDoc_STRVAR(__pyx_doc_8liburing_5error_2memory_error, "memory_error(self, str msg='is out of memory!') -> void\n\nRaises MemoryError ");
static PyMethodDef __pyx_mdef_8liburing_5error_3memory_error = {"memory_error", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8liburing_5error_3memory_error, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_8liburing_5error_2memory_error};
static PyObject *__pyx_pw_8liburing_5error_3memory_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("memory_error (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "memory_error", 0) < (0)) __PYX_ERR(0, 43, __pyx_L3_error)
      if (!values[1]) values[1] = __Pyx_NewRef(((PyObject*)__pyx_mstate_global->__pyx_kp_u_is_out_of_memory));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("memory_error", 0, 1, 2, i); __PYX_ERR(0, 43, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  2:
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("memory_error", 0, 1, 2, __pyx_nargs); __PYX_ERR(0, 43, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_msg), (&PyUnicode_Type), 1, "msg", 1))) __PYX_ERR(0, 43, __pyx_L1_error)
  __pyx_r = __pyx_pf_8liburing_5error_2memory_error(__pyx_self, __pyx_v_self, __pyx_v_msg);
...
static PyObject *__pyx_pf_8liburing_5error_2memory_error(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_msg) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  struct __pyx_opt_args_8liburing_5error_memory_error __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1.__pyx_n = 1;
  __pyx_t_1.msg = __pyx_v_msg;
  __pyx_f_8liburing_5error_memory_error(__pyx_v_self, 1, &__pyx_t_1); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
...
static PyObject *__pyx_pw_8liburing_5error_5index_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static CYTHON_INLINE void __pyx_f_8liburing_5error_index_error(PyObject *__pyx_v_self, unsigned int __pyx_v_index, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_index_error *__pyx_optional_args) {
  PyObject *__pyx_v_msg = ((PyObject*)__pyx_mstate_global->__pyx_kp_u_out_of_range);
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("index_error", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_msg = __pyx_optional_args->msg;
    }
  ...
  /* "liburing/error.pyx":50
 * cpdef inline void index_error(object self, unsigned int index, str msg='out of range!') except *:
 *     ''' Raises IndexError '''
 *     raise IndexError(f'`{self.__class__.__name__}()[{index}]` {msg}')             # <<<<<<<<<<<<<<
*/
  __pyx_t_2 = NULL;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_self, __pyx_mstate_global->__pyx_n_u_class); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_name); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_FormatSimple(__pyx_t_4, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyUnicode_From_unsigned_int(__pyx_v_index, 0, ' ', 'd'); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyUnicode_Unicode(__pyx_v_msg); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_7 = __Pyx_PyUnicode_Join(__pyx_t_6, 6, 1 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_3) + 3 * 2 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_4) + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_5), 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_3) | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_5));
  ...
  __pyx_t_8 = 1;
  {
    ...
    __pyx_t_1 = __Pyx_PyObject_FastCall((PyObject*)(((PyTypeObject*)PyExc_IndexError)), __pyx_callargs+__pyx_t_8, (2-__pyx_t_8) | (__pyx_t_8*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  __Pyx_AddTraceback("liburing.error.index_error", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
}
...
PyDoc_STRVAR(__pyx_doc_8liburing_5error_4index_error, "index_error(self, unsigned int index, str msg='out of range!') -> void\n\nRaises IndexError ");
static PyMethodDef __pyx_mdef_8liburing_5error_5index_error = {"index_error", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8liburing_5error_5index_error, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_8liburing_5error_4index_error};
static PyObject *__pyx_pw_8liburing_5error_5index_error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("index_error (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_self,&__pyx_mstate_global->__pyx_n_u_index,&__pyx_mstate_global->__pyx_n_u_msg,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "index_error", 0) < (0)) __PYX_ERR(0, 48, __pyx_L3_error)
      if (!values[2]) values[2] = __Pyx_NewRef(((PyObject*)__pyx_mstate_global->__pyx_kp_u_out_of_range));
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("index_error", 0, 2, 3, i); __PYX_ERR(0, 48, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    __pyx_v_self = values[0];
    __pyx_v_index = __Pyx_PyLong_As_unsigned_int(values[1]); if (unlikely((__pyx_v_index == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_msg = ((PyObject*)values[2]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("index_error", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_msg), (&PyUnicode_Type), 1, "msg", 1))) __PYX_ERR(0, 48, __pyx_L1_error)
  __pyx_r = __pyx_pf_8liburing_5error_4index_error(__pyx_self, __pyx_v_self, __pyx_v_index, __pyx_v_msg);
...
static PyObject *__pyx_pf_8liburing_5error_4index_error(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, unsigned int __pyx_v_index, PyObject *__pyx_v_msg) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  struct __pyx_opt_args_8liburing_5error_index_error __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  __pyx_t_1.__pyx_n = 1;
  __pyx_t_1.msg = __pyx_v_msg;
  __pyx_f_8liburing_5error_index_error(__pyx_v_self, __pyx_v_index, 1, &__pyx_t_1); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_8liburing_5error_trap_error, (void (*)(void))&__pyx_f_8liburing_5error_memory_error, (void (*)(void))&__pyx_f_8liburing_5error_index_error, (void (*)(void))&__pyx_f_8liburing_5error_raise_error, (void (*)(void)) NULL};
...
__Pyx_RefNannySetupContext("PyInit_error", 0);
  ...
  if (__pyx_module_is_main_liburing__error) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "liburing.error")) {
      if (unlikely((PyDict_SetItemString(modules, "liburing.error", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8liburing_5error_1trap_error, 0, __pyx_mstate_global->__pyx_n_u_trap_error, NULL, __pyx_mstate_global->__pyx_n_u_liburing_error, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_trap_error, __pyx_t_2) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     raise MemoryError(f'`{self.__class__.__name__}()` {msg}')
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8liburing_5error_3memory_error, 0, __pyx_mstate_global->__pyx_n_u_memory_error, NULL, __pyx_mstate_global->__pyx_n_u_liburing_error, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[1]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_memory_error, __pyx_t_2) < (0)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     raise IndexError(f'`{self.__class__.__name__}()[{index}]` {msg}')
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8liburing_5error_5index_error, 0, __pyx_mstate_global->__pyx_n_u_index_error, NULL, __pyx_mstate_global->__pyx_n_u_liburing_error, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[2]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_index_error, __pyx_t_2) < (0)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_kp_u_trap_error_line_1, __pyx_mstate_global->__pyx_kp_u_Trap_Error_Type_no_int_msg_str) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init liburing.error", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init liburing.error");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 * 
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_kp_u_); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     raise MemoryError(f'`{self.__class__.__name__}()` {msg}')
*/
  __pyx_mstate_global->__pyx_tuple[1] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_kp_u_is_out_of_memory); if (unlikely(!__pyx_mstate_global->__pyx_tuple[1])) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 *     raise IndexError(f'`{self.__class__.__name__}()[{index}]` {msg}')
*/
  __pyx_mstate_global->__pyx_tuple[2] = PyTuple_Pack(1, __pyx_mstate_global->__pyx_kp_u_out_of_range); if (unlikely(!__pyx_mstate_global->__pyx_tuple[2])) __PYX_ERR(0, 48, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 10; } index[] = {{0},{4},{179},{727},{1},{4},{3},{3},{1},{8},{17},{13},{22},{19},{20},{18},{9},{18},{8},{5},{11},{13},{5},{14},{8},{12},{10},{3},{8},{2},{3},{12},{12},{4},{12},{10},{8},{10},{6},{480},{26},{30},{35}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (989 bytes) */
const char* const cstring = "BZh91AY&SY\322\306 \277\000\000\321\377\377\346q\254\000|\377\346S\277\245\374:\377\377\377\342@@@@@@@@@\000@@@\000@\000P\003~s\266\240\304\320;\212P\014\232\032\000\321\246\200\006\200\006#&\200\000\001\240\364\2156\240\321 \247\350\236&JzL=P=#@\000=@\000\000\000\000\000J\010LB\247\350\310\021\210\324M\251\241\230\221\350&\206\200\032\014A\243L \034\031\006\215\000d\323\020\323A\220b\030@\320\03211\032\000\000\022\204\211\251\247\202A\243F\206\201\352\031\003@\000\000\03244\000d\321R\342I\336o+a\207\313-\273\243\202}\321\204H\336\363\344\360\207\253=J!#L\316G1f{\240\232<\"\225\314J*\257\210\001\025\217&D\005\206\366\376\301$\214\303\005y\320$\347\355>Z|\215\310I\022\036_\353\315\325\360\313\010q\267\240\351\350\363\302\030\364\265ta\2555\330\363k\344C\370\246\004\333U\216\2524\241\253+\221\312\334\245_B\275a\342\n\322\233c\373\361\341*\307\177/\263\205e\024\3238\010 \340.\223\352A\302\nP\250OT\357\211\031s\004\226'<\3137\271\247\204\331pk6\023p\303\ro\211\245\256\023(\177Fd\312\241\n\204`\320\335\034;\031\354\037A\353&\253a\244n\214\336\tl\374\213\317\302vq\013\207\016\021\2541w\313\334s\253y\246\334\203\224.\366\300\261}/\225r\3624V\224+ZP\316\005GVYM`P\241)$\364\246\257,\n\347033\307\272\327\272\252\250Mz,\001\201 \250\310\270;76\216\226\373vvr\0131\347\267\323\344\322\236\317\\S}\003\277\347\223\241\242\337\223\255G\357\273\240p\326\003>m\330\247%\007Im\205\375\237\243\222\334\215\036\256\350\244\035\022\332fh\350\275,\255\213\035\344\361\026B\374\322/\013\2129\333ta\305;\026\335YH\032\251s{\272\267M\265k\245\3626Y\277uN7\235\263G\036v\333\3536,d\367\263\377:0yF\020\264\024\245\266\276\311|\246\2002\024<\274m\346UE/+\203\334\320\310\300s\tg\347n\3303\252\315\201~\220\343\254\320@\341A\310\240\002\305\202J=\214\2402\275B\210\235\344\226\222\330\r\177U\343T,\311;\206\261\020\\\311\032 \300^\303\020\006\274\362\021^\025\253\221\212m\"i\3122\202\230\253\211`\020T\240\030O\226\203\001\361\022h\263(\222\235\360i\235+\350\026\216\324l\237p\251\226\350\014<\036@\353""\342v\204\027j\2174l\352\023\263\025\360\\*\324\232\026/\2756\004\202]q\332\024\256\245\245f\004\343\261QQ\331#*D\225R\221F\007\261\330I\236\247B\032\0000\205EDG\237\032 Y\320\013F(\255H\317\216X#\201+\022~\2514V\347Y0q(g\004\3706\364t\377\336;\003j\242QUDF\255h\335\270\001\031f\307\027\263\223\020&\262D\320\034J\210%O\234\242\n\240\212*\005f\020\021\211\254\024\205\257\357\365\301\224\025\343{\r\301I\303<F\030\326m&\350\360\352\204\323u\007\024\314\332lNeH\377\267'\001\324\031\033Q<.\032'=\231\345\254%\252\250\314\215ug\223\016'-o+d\330\032Am3^\320\005\202\021\276\020\277\374\221\210_\332\347\353S\230R\221\023k\004g\226d\26120ED724G\300#8Z\004\267\344\313,\002u\030 \010\346\221\204\034\026\363\247(\227aK\223\324\022\377\031\321\340k=b\243#G\366}\323\241\350\220\347\377\027rE8P\220\322\306 \277";
...
const char* const cstring = "x\332\255T\301n\0337\020\225\201\026puh\021\264\0370I\nXre\245\002\\ \010\020\007N\342\006\001\002\307I|i\203\200\032qg%F\\rMr]\355\241@\217>\352\250c\2169\352\350c?!\307\034\363\t\375\204\016w-Y\312\3011\320.\260\344\2223\363\336\0149o\017\255\241C\033\010\302\010\003<*\303\310\032P\036\022\322j@\016\003\351\022|pJ\006r\321\311\300\321\301\321\316\356\335]@\223\200\243\267$\203\007_\014\244F\357\311\203MaP(\035\224\201P\346\344\273\3604\205\322\026`\210\022\010\026r\366[\r\010#2\340)\304\017\330Bcl\300\240\254\021\034\256\314p\013\022\345\230D\235R\214\376\025\265\247.\034;\314\341\3009\353\232M\270x\216\231n\271\210\217\261\325\244LX\333\316\3740N\\\325\332\266\243P8Sy/\367\017&\230\345z\035uoo\017\002\323\013\212\364\255^{\315\332k^\345\274\323\373\314\375\241\266r\314U>}^\025s\017^\363\314y\367zo\340%y[8\311eS\226[\207N\361]\024\006OQi\034pV_`\352\300\226\267\031AF\336\343\220\266\256\317\274\032\366\005\226u\320\333\220\224\0063%\241\262\303\000=_:\267T\237\"x\377\022,6\335Z\350\0167T\t}\316`\357>\374\334\217M(\255\361*!\307\020\036S\352~\346\257\322\350~\177\247\307\316\001\376PZ\203\034\221\034\363g\030-\030!U\316\207\3309\236(\206\344\316\346\334\312u~L\302\235\327Y\003\206\272\263Q\371\013U\240\007\232H\312cS^\026\360*'\251P\257\205\036\263>\306>\222\335\022#\034\030\034\250p\013R&\2226\343\263\206\"\257\223\013#fN\013##&\360\211\325g\321o\265\373\320j\277~\323\207\007\230$\202\245@\354h\213\020e\225Qf]y\363b\345\320\014\351\246w\362\016+\265p\214~\247\252\251\233\227\223\313\033\202\226V\206\240\327\026\342\250\234\360\373\230\225,\016i\022^R\212\2764R\331\256\264\216A\331\317\013Q\2512N\274\024\212E\350P\322\000\345X\210\230\257\340\275\204&\325P3\010\345\305\022@q\253\372E>\335\332.2d\034Qg/\026{6)4\361\354\207B\304\372y\264\271\315\205\340\364\205\304\\\t~N\n\324\265\321\223N\343\030\304b\035\022.\240\320A\210@>\216\313\232OQ\027\344Y\307\320\342\241\023\025\r5\256\037\253\\$\312\347\030\344\250\023\377\000\205\\\330l\036\004\272\241\027w\027\371\213_""\352dWNs{\351\313\367\206\272\nh7N\255J\240uT>\037\304\277!l\377w\312\325\303\2726i\301j\031\032\026\313\377R\365\312\025_\231\3015\341*=]\twy\314\215\325\362\033+\2114VP>4v\347\373\237\276j\236\3754}1\225\263\033\263\037go\337\177;\307\371\311\207\306\223\277O\242e{\272?}5\333\230\3750\373\375\335\237\363\375\371o\347x\316\326\316\373g\347\033\377\334k|\275\371\227?\273}\366\342\343\346wg'\237\276i~\334\374~\332\233>\236m\374\013\352rf\366";
...
const char* const bytes = "NoneNote that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False. Trap Error\n\n        Type\n            no     int\n            msg    str\n            return int\n\n        Example\n            >>> trap_error(1)\n            1\n\n            >>> trap_error(-11)\n            BlockingIOError: [Errno 11] Resource temporarily unavailable\n\n            >>> trap_error(-11, 'some message')\n            BlockingIOError: [Errno 11] some message\n\n            >>> trap_error(-1)\n            # dynamic error based on `errno`\n\n        Note\n            - any `no >= 0` is considered safe.\n            - if `no=-1` it will check with `errno` first to see if proper error is set,\n              and raise that as exception\n\n        Special\n            Thanks to \"_habnabit\" for coming up with this function name\n    `()` ()[]` ?add_noteis out of memory!out of range!src/liburing/error.pyxtrap_error (line 1)__Pyx_PyDict_NextRefasyncio.coroutines__class__cline_in_traceback__func__indexindex_error_is_coroutineitemsliburing.error__main__memory_error__module__msg__name__nopop__pyx_capi____qualname__self__set_name__setdefault__test__trap_errorvaluesint (int, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_trap_error *__pyx_optional_args)\000void (PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_memory_error *__pyx_optional_args)\000void (PyObject *, unsigned int, int __pyx_skip_dispatch, struct __pyx_opt_args_8liburing_5error_index_error *__pyx_optional_args)\000void (struct __pyx_opt_args_8liburing_5error_raise_error *__pyx_optional_args)\000trap_error\000memory_error\000index_error\000raise_error\320\0004\260A\340\004\n\210+\220Q\220c\230\021\230$\230j\250\016\260a\260q\320\000G\300q\340\004\n\210*\220A\220S\230\001\230\024\230Z\240}\260A\260Y\270a\270q\320\000,\250L\270\001\360:\000\005\010\200s\210#\210Q\330\010\017""\210q\340\t\n\330\010\023\2201\220D\230\001";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_no, __pyx_mstate->__pyx_n_u_msg};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_liburing_error_pyx, __pyx_mstate->__pyx_n_u_trap_error, __pyx_mstate->__pyx_kp_b_iso88591_L_s_Q_q_1D, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_liburing_error_pyx, __pyx_mstate->__pyx_n_u_memory_error, __pyx_mstate->__pyx_kp_b_iso88591_4A_Qc_j_aq, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 48};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_index, __pyx_mstate->__pyx_n_u_msg};
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_liburing_error_pyx, __pyx_mstate->__pyx_n_u_index_error, __pyx_mstate->__pyx_kp_b_iso88591_Gq_AS_Z_AYaq, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
