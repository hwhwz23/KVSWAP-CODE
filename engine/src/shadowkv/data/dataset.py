...
DATADIR = {
    ...
    # 'ruler': '/home/schz/KVSwap/benchmark_root',
    'ruler': '/home/schz/ext_disk/benchmark_root',
    'niah': 'data/niah/data',
}

class Dataset:
    def __init__(self, dataset_name, tokenizer, datalen, num_samples, rank=0, world_size=1, model_name=None):
    ...
    def get_dataset(self):
        if 'ruler' in self.dataset_name: # ruler/xxx
            ...
            dataset = load_dataset("json", data_files=f'{DATADIR["ruler"]}/{model_dir}/synthetic/{self.datalen}/data/{task}/validation.jsonl', split='train')
